...
def parse_config():
    ...
    parser.add_argument('--base_model', type=str, default="/model/llama-7b-hf")
...
def main(args):
    ...
    orig_ctx_len = getattr(config, "max_position_embeddings", None) # 4096 for LLaMA2 models
